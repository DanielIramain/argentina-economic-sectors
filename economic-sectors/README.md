...
9. Create, download and insert into the root directory the JSON with the service account from GCP using the new project (it has to be created in GCP before running the flow in the next steps)
